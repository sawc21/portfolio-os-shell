...
const priorityMatches: Record<string, AppId[]> = {
  ...
  ai: ["publications", "projects", "skills", "recruiter", "systems-lab"],
  cybersecurity: ["publications", "projects", "resume", "recruiter", "skills"],
  cti: ["publications", "projects", "resume", "skills"],
  llm: ["publications", "projects", "skills", "recruiter"],
  backend: ["resume", "projects", "skills", "recruiter"],
  "rest api": ["resume", "projects", "skills"],
