...
export const commandDefinitions: CommandDefinition[] = [
  ...
  { name: "open systems lab", description: "Open Systems Lab", aliases: ["open systems lab", "systems", "systems lab", "workflow lab", "automation"], targetAppId: "systems-lab" },
  { name: "open workflows", description: "Open Workflow Console", aliases: ["open workflows", "workflows", "workflow console", "tools"], targetAppId: "workflow-console" },
  { name: "open publications", description: "Open Publications & CV", aliases: ["open publications", "publications", "papers", "research", "cv"], targetAppId: "publications" },
  { name: "open project notes", description: "Open Project Notes", aliases: ["open project notes", "project notes", "notes", "notebook", "research notebook"], targetAppId: "notes" },
...
export function runKernelCommand(rawCommand: string, provider: PortfolioDataProvider): SystemAction {
  ...
  return systemActions.print([`Unknown command: ${rawCommand}`, "Type help, apps, search systems, or hire sawyer."]);
}
